...
imgReal = face_recognition.load_image_file('../facerecognitionproj/trainingimages/shristina2.jpg')
imgReal = cv2.cvtColor(imgReal,cv2.COLOR_BGR2RGB)

imgTest = face_recognition.load_image_file('../facerecognitionproj/trainingimages/aastha1.jpg')
